...
class RouteListApproveDetailsActivity : AppCompatActivity() {
    ...
    private fun initView() {
        ...
        adapter = RouteDetailsAdapter(this, contribution, routeTarget)
          designationId =this.intent.getStringExtra("designation_id")!!
       // val srId = sessionManager.userId
        ...
        showLoadingDialog()
        retailerListBySrRoute(userId, routeId, designationId.toString())
