                                        ...
                                        if (response.isSuccessful) {
                                            ...
                                            if (apiResponse != null) {
                                                if(apiResponse.success){
                                                    ...
                                                    showDialogBox(SweetAlertDialog.SUCCESS_TYPE, "SUCCESS-S5802", "Morning Attendance Submit Successfully")
                                                }else{
                                                    dismissLoadingDialog()
                                                    showDialogBox(SweetAlertDialog.WARNING_TYPE, "Waring-SF5802", apiResponse.message)
                                                }
                                            }else{
                                                dismissLoadingDialog()
                                                showDialogBox(SweetAlertDialog.ERROR_TYPE, "Error-RN5802", "Response NULL value. Try later")
                                            }
                                        } else {
                                            dismissLoadingDialog()
                                            showDialogBox(SweetAlertDialog.ERROR_TYPE, "Error-RR5802", "Response failed. Try later")
                                        }
                                    }

                                    override fun onFailure(call: Call<AttendanceResponse>, t: Throwable) {
                                        dismissLoadingDialog()
                                        showDialogBox(SweetAlertDialog.ERROR_TYPE, "Error-NF5802", "Network error")
                                    }
                                })
