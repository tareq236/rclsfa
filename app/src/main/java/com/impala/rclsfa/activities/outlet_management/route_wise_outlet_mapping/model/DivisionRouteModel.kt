...
class DivisionRouteModel {
    ...
    class Result {
        ...
        override fun toString(): String {
            return dsmAddress.toString() // What to display in the Spinner list.
        }

        override  fun equals(other: Any?): Boolean {
            if (other is DivisionRouteModel.Result ) {
                val c: DivisionRouteModel.Result  = other as DivisionRouteModel.Result
                if (c.dsmAddress.equals(dsmAddress) && c.id === id && c.dsmCode === dsmCode )
                    return true
            }
            return false
        }
