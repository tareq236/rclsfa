...
class LocationUpdateActivity : AppCompatActivity(), OutletListForLocationAdapter.IClickManage {
    ...
    private fun getLastLocation() {
        ...
        fusedLocationClient?.lastLocation!!.addOnCompleteListener(this) { task ->
            if (task.isSuccessful && task.result != null) {
                ...
                Log.w(LocationUpdateActivity.TAG, "getLastLocation:exception", task.exception)
    ...
    private fun startLocationPermissionRequest() {
        ActivityCompat.requestPermissions(
            ...
            LocationUpdateActivity.REQUEST_PERMISSIONS_REQUEST_CODE
        )
    }
    ...
    private fun requestPermissions() {
        ...
        if (shouldProvideRationale) {
            ...
            Log.i(LocationUpdateActivity.TAG, "Requesting permission")
            startLocationPermissionRequest()
        }
    }
    ...
    override fun onRequestPermissionsResult(
        ...
        Log.i(LocationUpdateActivity.TAG, "onRequestPermissionResult")
        if (requestCode == LocationUpdateActivity.REQUEST_PERMISSIONS_REQUEST_CODE) {
            when {
                grantResults.isEmpty() -> {
                    // If user interaction was interrupted, the permission request is cancelled and you
                    // receive empty arrays.
                    Log.i(LocationUpdateActivity.TAG, "User interaction was cancelled.")
                }
