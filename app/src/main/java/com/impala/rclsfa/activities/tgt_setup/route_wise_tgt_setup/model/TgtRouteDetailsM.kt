package com.impala.rclsfa.activities.tgt_setup.route_wise_tgt_setup.model
...
class TgtRouteDetailsM {
    ...
    class Result {
        ...
        @Expose
        var targetAmountRe: Any? = null

        @SerializedName("target_per_re")
        @Expose
        var targetPerRe: Any? = null

        @SerializedName("kro_target_amount")
        @Expose
        var kroTargetAmount: Any? = null
